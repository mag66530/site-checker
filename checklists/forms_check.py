...
if _alive and _this and not _done_by_log:
    ...
    st.caption(f'⏳ Идёт… {_mmss}. Один город - обычно 2-10 минут; несколько '
               'городов, а также при блокировках сайта / капче / сбросах '
               'соединения - заметно дольше (20-30+ минут). Время зависит от '
               'числа форм, городов и отклика сайтов. Страница обновляется сама - '
               'можно уйти на другие вкладки, прогон не прервётся.')
