...
if pid:
        ...
        with _cb_col2:
            ...
            st.checkbox('1.15  Изображения (alt, webp/avif, вес, имена файлов)',
                        ...
                        help='Alt у всех <img> (пустой alt="" ок; баг - полное '
                             ...
                             'Content-Length: чек-лист ≤100 КБ (замечание), '
    ...
    with st.container(border=True):
        ...
        st.checkbox('Ошибки JavaScript в консоли + мобильная вёрстка (браузер)',
                    ...
                    help='Открывает в браузере КАЖДУЮ страницу прогона (главная, '
                         ...
                         'мобильная вёрстка (390px): шрифт минимум 14px, контент '
                         'не шире экрана (таблицы/блоки не вылазят). Тяжёлый '
                         'браузерный проход - по запросу.')
