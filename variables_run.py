...
_ЛЕГЕНДА = [
    ...
    ("✗  – расхождение. Любой из случаев: значение на сайте ДРУГОЕ, чем в КП; "
     ...
     "В примечании ячейки видно, ЧТО в КП и ЧТО на сайте: «КП / На сайте».", False),
    ("⚠  – только то, что нельзя проверить автоматически (напр. кнопка WhatsApp "
     "есть, но номер в ссылке не читается) - сверьте вручную.", False),
    ("И ✗, и ⚠ также собраны списком на листе «Расхождения».", False),
    ("–  – значения нет НИ в КП, НИ на сайте (проверять нечего).", False),
