    ...
    for g in каталог.get('цели', []):
        ...
        if t == 'js':
            ...
            if _лид_цель(g):
                ...
                # ПЕРЕД формами: если reachGoal формы есть в коде, цель рабочая, даже
                # если Москва-прогон форм goal-сигнал не поймал (findtome, managerform
                # на СНГ и т.п.). Сканируем весь код страниц разом - надёжный сигнал.
