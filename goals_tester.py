...
_MPINEW_ОЖИДАЕМЫЕ = [
    ...
    # Две цели, ради которых мы ЖМЁМ «В корзину» на листинге и на товаре.
    # В коде сайта их нет (там свои listing-klik-v-korzinu / tovar-klik-v-korzinu),
    # а в Метрике они заведены с ошибкой - в поле «идентификатор содержит»
    # вставлен весь вызов ym(99536626,'reachGoal','addtocart'). Держим их в
    # «ожидаемых», иначе строка «Нет в коде сайта» прячется как шум - а это
    # ровно та находка, которую надо показать.
    'addtocart', 'cartopen',
]
