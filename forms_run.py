...
def main() -> int:
    ...
    _stamp('СБОРКА проверки форм: mpk-fix-18 · «Обработка ошибок»: ошибку и успех '
           'ловим ОДНОВРЕМЕННО (что раньше - то и вердикт), обычные не-AJAX формы '
           'больше не прочерк; согласие ТЕКСТОМ ищется и РЯДОМ с формой - вердикт '
           'и формулировка едины на всех формах; активная проба спама (3 отправки) '
           'идёт и на форме заказа')
