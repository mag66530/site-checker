...
def main() -> int:
    ...
    _stamp('СБОРКА проверки форм: mpk-fix-21 · «Обработка ошибок»: реакцию ловим '
           'сравнением КОНКРЕТНЫХ блоков «было/стало» (блок ошибки у сайта - id без '
           'класса, старый детектор его не видел, а панель «Спасибо» отрисована '
           'заранее - отсюда ложный «ложный успех»); в лог всегда пишем, ПОЧЕМУ '
           'строка не заполнена - прочерк больше не молчит')
