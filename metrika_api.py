...
COUNTER_GROUPS = {
    ...
    'mpe': ['99551890'],
    # МПК: свой счётчик на каждый доменный сайт. Счётчики маркетплейсов
    # (pulscen/tiu/all-gorod) и карточек Яндекс.Карт сюда НЕ берём - у токена их
    # больше сотни, а к сайтам проекта они отношения не имеют.
    'mpk': [
        '21630337',  # metpromko.ru
        '21636463',  # metpromko.kz
        '92687116',  # metpromko.by
        '92687198',  # metpromko.kg
        '92687185',  # metpromko.uz
        '92687179',  # metpromko.az
        '92739575',  # metpromko.am
    ],
    'imp': [
