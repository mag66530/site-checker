...
def test_согласие_текстом_единый_вердикт_везде():
    # Формулировка колонки ЕДИНАЯ, где бы ни лежал текст: и «у кнопки», и «рядом
    # с формой» дают ✗ с пояснением «чекбокса нет, но текст есть».
    for где in ('у кнопки', 'рядом с формой'):
        ...
        assert sym == '✗'
        assert 'ЧЕКБОКСА' in ком and где in ком
