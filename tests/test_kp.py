...
def test_address_match_yo_e_interchangeable():
    """«Леднёва» (КП) vs «Леднева» (карточка Яндекс.Карт) - тот же адрес, ё и е
    пишут вперемешку в разных источниках. Баг: улица Новороссийска с ё в КП не
    находилась в тексте карточки с е - ложное расхождение при фактически
    одинаковом адресе."""
    assert address_match(
        'Краснодарский край, Новороссийск, улица Леднева, 5, 353900',
        'улица Леднёва, 5')
    assert address_match('улица Ёлкина, 3', 'улица Елкина, 3')
