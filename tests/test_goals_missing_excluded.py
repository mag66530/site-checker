"""Тест: цели со статусами «Не найдена/найдено на сайте» и «Нет в коде сайта»
исключены из отчёта.
...
поддомене), или reachGoal цели не найден в коде сайта - проверять/показывать
нечего. По просьбе такие строки в отчёт не выводим и не учитываем в счётчиках.
"""
import os
import sys
