...
def test_price_detected_in_cis_currencies():
    ...
    html = ('<header><a href="tel:1">т</a></header><div class="breadcrumb">x</div>'
            ...
            '<a href="/c/t/">Товар</a><img src="/i/a.jpg"><span>43 465.34 UZS</span>'
            '<span class="an-ico-basket">В корзину</span></div>')
    b = _by_key(check_content(html, 'category', url='https://inmetprom.uz/catalog/x/'))
