...
BLOCK_DESCRIPTIONS = {
    'photos':        'Фото товаров: в карточках товаров ищем заглушку «нет фото» (picture.missing и т.п.). Нашли – у части товаров фото нет, в ячейке «БАГ (число)» = сколько без фото. Нет карточек товаров (напр. корень каталога) – «–», не проверяем.',
