...
FORM_WHERE = {
    ...
    # SHOPMET («Заказать звонок» и «Оформление заказа» уже выше)
    ...
    # Точное название с «(О нас)» - иначе сработал бы ключ «Рассчитать заказ»
    # от МПЭ (там это форма в подвале с прикреплением файла).
    'Рассчитать заказ (О нас)': 'Кнопка «Оставить заявку» на странице «О нас», '
